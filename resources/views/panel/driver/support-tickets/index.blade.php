...
@section('content')
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="px-4 pt-0 space-y-3 mt-5" id="ticketListContainer">
            ...
            @include('panel.driver.support-tickets.partials.ticket-list')
        </div>
    ...
    <div class="fixed bottom-5 right-3">
        <a href="{{ route('panel.driver.support-tickets.create', ['ticket_type_id' => 'new']) }}"
...
@push('script')
    <script>
        ...
        function fetchTickets(page, status, append = true) {
            ...
            const url = `{{ route('panel.driver.support-tickets.index') }}?page=${page}&status=${status}&sso_token=${sso_token}`;
