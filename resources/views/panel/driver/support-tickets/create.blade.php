    ...
    <div class="">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-4 space-y-5">
                <form id="ticketForm" class="space-y-3"action="{{ route('panel.driver.support-tickets.store') }}"
                    method="POST">
                    @csrf
                    <!-- Priority -->
                   <div>
                        ...
                        <div class="flex gap-6 opacity-70 @if ($order) pointer-events-none select-none @endif">
                            @foreach (\App\Models\SupportTicket::PRIORITIES as $key => $priority)
                                <label
                                    class="flex items-center gap-2 @if ($order) cursor-not-allowed @endif">
                    ...
                    <div>
                        ...
                        @else
                            <input type="text" id="subject" name="subject"
                                class="w-full h-11 border border-gray-300 rounded-lg px-3 text-gray-900 focus:outline-none"
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="5"@if ($order) autofocus @endif
