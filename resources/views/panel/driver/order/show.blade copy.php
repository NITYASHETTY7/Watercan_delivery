                    ...
                    <div class="shadow-sm space-y-3">
                        ...
                        @if ($order->status == \App\Models\Order::STATUS_INROUTE)
                            <div class="bg-white p-4 rounded-xl border border-blue-200">
                                {{-- The form is used to collect the file data via JavaScript FormData --}}
                                <form id="deliveryConfirmationForm" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        {{-- START: Custom Upload Dropzone --}}
                                        <div id="dc-upload-area"
                                            class="mb-3 p-6 border-2 border-dashed border-gray-300 rounded-lg text-center cursor-pointer hover:border-blue-500 transition-colors bg-gray-50 hover:bg-white"
                                            onclick="document.getElementById('delivery_challan').click()">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">
                                                Upload Delivery Challan to confirm the delivery.
                                            </p>

                                            {{-- Display selected file name --}}
                                            <p id="selectedFileName"
                                                class="mt-2 text-sm text-blue-600 hidden font-semibold"></p>

                                        </div>
                                        {{-- Hidden File Input --}}
                                        <input type="file" name="delivery_challan" id="delivery_challan"
                                            accept=".jpeg,.png,.jpg" required class="hidden" />

                                        {{-- Validation and constraints messages --}}
                                    ...
                                    {{-- Button starts disabled (default state) --}}
...
@push('script')
    ...
    <script>
        ...
        function checkFileValidity() {
            // Check if input element exists before reading properties
            ...
            // File is valid
            dcFileError.classList.add('hidden');
            selectedFileName.textContent = `File Selected: ${fileName}`;
