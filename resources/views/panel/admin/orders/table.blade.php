<table id="table" class="table p-0">
    <thead>
        <tr>
            ...
            <th class="col_3" style="min-width: 200px;">
                @lang('ui.status')
            </th>
            <th class="col_3" style="min-width: 100px;">
            ...
            @foreach (@$orders as $order)
                <tr id="{{ @$order->id }}">
                    ...
                    <td>
                        ...
                        {{-- Screen view (Stepper) --}}
                        <ol class="report-stepper status-{{ $order->status }} no-export">
                    ...
                    <td class="col_8">{{ @\Carbon\Carbon::parse($order->date)->format('d-m-Y') ?? '--' }}</td>
