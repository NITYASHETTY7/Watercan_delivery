...
<div class="modal fade" id="updateProfileImageModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered center">
        <form action="{{ route('panel.admin.profile.update.profile-img', secureToken($user->id)) }}" method="POST"
            ...
            @csrf
            <x-input name="request_with" placeholder="" type="hidden" tooltip="" regex="" validation="empty" value="profile_img" />
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    @csrf
                    <div class="form-group mt-5 text-color-white">
                        <x-file name="avatar" version="image" class="cyBlogBannerImage" validation="profile_img" accept=".jpg,.png,.jpeg" />
                    </div>
                    <img id="imagePreview" class="d-none" src="#" alt="your image" />
                    <div class="demo"></div>
                    <x-input name="croppedImageData" id="croppedImageData" placeholder="" type="hidden" tooltip="" regex="" validation="empty" value="" />
                </div>
