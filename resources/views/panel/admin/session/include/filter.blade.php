        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 form-group">
                    <x-label name="user" validation="empty" tooltip="" />
                    <x-select name="user" validation="user" id="user" class="form-control select2 getUsersList" label="item" value="{{ old('user') }}" optionName="name" />
