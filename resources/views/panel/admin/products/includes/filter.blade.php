...
<div class="side-slide" style="right: -100%;">
    <div class="filter">
        ...
        <div class="card-body">
            <form action="{{ route('panel.admin.products.index') }}" method="GET" class="d-flex" id="TableForm">
                <div class="row">
                    ...
                    {{-- <div class="col-12 form-group mr-2 align-items-center">
                        <x-label name="is_published" validation="empty" tooltip="" />
                        <x-select name="is_published" value="{{ request()->get('is_published') }}" label="Is Published"
                            class="select2" validation="empty" optionName="label" id="is_published" :arr="$is_published" />
                    </div> --}}
                    <div class="col-12">
