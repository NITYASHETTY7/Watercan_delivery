...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        {{-- <div class="d-flex align-items-center"> --}}
                            {{-- <a href="{{ route('panel.admin.products.create') }}" class="btn btn-sm btn-outline-primary mr-2" title="Add New Product"><i class="fa fa-plus" aria-hidden="true"></i> @lang('ui.add') </a> --}}
                            {{-- <form action="{{ route('panel.admin.products.bulk-action') }}" method="POST"
                                id="bulkAction" class="">
                                @csrf
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu multi-level" role="menu"
                                        ...
                                        <x-button type="submit"
                                            ...
                                            data-value="" data-message="You want to delete these Products?"
                    ...
                    <div class="card-body">
                        <div id="ajax-container" style="display: none;">
                            @include('panel.admin.products.load')
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('panel.admin.products.includes.filter')
@endsection
...
@push('script')
    ...
    <script>
        $(document).on('click', '#export_button', function () {
            ...
            const moduleName = "{{ @$label ?? 'Products' }}";
