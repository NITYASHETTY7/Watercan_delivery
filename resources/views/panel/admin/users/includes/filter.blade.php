...
<div class="side-slide" style="right: -100%;">
    <div class="filter">
        ...
        <div class="card-body">
            <form action="{{ route('panel.admin.users.index') }}" method="GET" class="d-flex" id="TableForm">
                <x-input type="hidden" name="role" value="{{ request()->get('role') }}" />
                <div class="row">
                    ...
                    <div class="col-12 form-group mr-2 align-items-center">
                        ...
                        <x-select name="is_active" value="{{ request()->get('is_active') }}" label="Status"
                            class="" validation="empty" optionName="label" id="is_active" :arr="$statuses" />
                    </div>
                    <div class="col-12">
