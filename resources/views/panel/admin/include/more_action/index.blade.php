<script defer>
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                ...
                                success: function(res) {
                                    ...
                                    // alert(res.count);
                                    if (res.count == 0) {
                                        $(document).find('.move-to-trash').addClass(
                                            'd-none');
                                    }
                                    setTimeout(() => {
                                        $(ajaxMessage).html('');
    ...
    // END BULK ACTION ON CLICK


    // START BULK ACTION ON CHNAGE 
    ...
    // END BULK ACTION ON CHANGE


    // START BULK ACTION UPDATE
