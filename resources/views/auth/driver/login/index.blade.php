...
@section('content')
    <section class="bg-home-75vh">
        <div class="container">
            <div class="row form-center mt-7">
                        ...
                        <div class="card-body p-6 text-center">
                            @if (getSetting('authentication_mode') == 1)
                                <div class="bg-white form-signin">
                                    <form method="POST" action="{{ route('login', $role) }}" class="login-form mb-0"
                                        autocomplete="off">
                                        @csrf
                                        <a href="{{ route('index') }}">
                                            <img src="{{ getBackendLogo(getSetting('app_logo')) }}"
                                                class="avatar-small d-block mx-auto" height="100px" alt="">
                                        </a>
                                        <h1 class="my-3 text-center fs-18">Sign In To Driver Panel</h1>
                                        @if (session('error'))
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="password"
                                                ...
                                                id="password-field" placeholder="Password" name="password"
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <p class="forgot-pass mb-0">
                                                <a href="{{ route('password.forget') }}"
                                                    class="fw-normal fs-14 hover">Forgot
                                                    password ?</a>
                                            </p>
                                        </div>

                                        <button class="btn btn-primary w-100 rounded-pill" type="submit">Secure
                                            Sign-In</button>
                                       
                                        <!--end col-->
                                        <p class="mb-0 text-muted mt- 5text-center">©
                                            <script>
                            ...
                            @else
                                <div class="py-3 bg-white rounded shadow form-signin">
                                    <form action="{{ route('login-validate') }}" method="POST"
                                        ...
                                        <h1 class="mb-5 text-center fs-18">Sign in to {{ getSetting('app_name') }}</h1>
                                        <div
                                        ...
                                        <button type="submit" class="btn btn-primary w-100 mt-5"
                                            style="width:auto!important;margin:auto;display:block;">
                                            <span class="text-white"> Verify By OTP</span></button>
                                    </form>
                                </div>
                            @endif
                        </div>
