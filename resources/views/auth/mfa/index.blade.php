                    ...
                    <div class="p-3 bg-white rounded shadow form-signin">
                        <form method="POST" action="{{ route('2fa') }}">
                            ...
                            @if ($errors->any())
                                ...
                                @endforeach
                            @endif
                            <label class="text-muted" for="">Please enter your Google Authenticator OTP <span
                                    class="text-danger">*</span></label>
                            <div class="form-floating">
                                <input required type="number" placeholder="Enter OTP" name="one_time_password"
                                    class="form-control @error('one_time_password') is-invalid @enderror" id="floatingInput"
                                    autofocus>
                            ...
                            <div class="col-12 text-center mt-3">
                                <p class="mb-0 mt-3"><span class="text-dark me-2">Facing Trouble?</span>
                                    <a href="{{ route('otp-form-index') }}" class="text-link">
