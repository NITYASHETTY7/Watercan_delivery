...
//     if(status == 'start'){
//         $('#ajax-container').html('<div id="floatingBarsG"> <div class="block-g" id="rotateG_01"></div> <div class="block-g" id="rotateG_02"></div> <div class="block-g" id="rotateG_03"></div> <div class="block-g" id="rotateG_04"></div> <div class="block-g" id="rotateG_05"></div> <div class="block-g" id="rotateG_06"></div> <div class="block-g" id="rotateG_07"></div> <div class="block-g" id="rotateG_08"></div> </div>');

//         $('.ajax-multi-container').html('<div id="floatingBarsG"> <div class="block-g" id="rotateG_01"></div> <div class="block-g" id="rotateG_02"></div> <div class="block-g" id="rotateG_03"></div> <div class="block-g" id="rotateG_04"></div> <div class="block-g" id="rotateG_05"></div> <div class="block-g" id="rotateG_06"></div> <div class="block-g" id="rotateG_07"></div> <div class="block-g" id="rotateG_08"></div> </div>');
//     }
// }

function tableLoading(status, theme) {
    if (status == 'start') {
    ...
    <div class="sh-card">
        <div class="d-flex gap-2 justify-content-between" style="margin: 0 10px 0 10px;">
            <div class="sh-xl shimmer" style="width: 8%; margin-right: -34px;"></div>
            <div class="sh-lg shimmer" style="width: 8%; margin-right: 584px;"></div>
            <div class="sh-lg shimmer" style="width:15%; margin-right: -51px;"></div>
            <div class="sh-lg shimmer" style="width: 4%;"></div>
        </div>
    </div>
</div>

<div class='shimmer-container' >
    <div class="sh-card" style="margin: 0 10px 0 10px;">
        <div class="d-flex gap-2 justify-content-between">
            <div class="sh-xl shimmer" style="width: 23%; height:80px; border-radius:8px !important; margin-right: 10px;"></div>
            <div class="sh-xl shimmer" style="width: 23%; height:80px; border-radius:8px !important; margin-right: 10px;"></div>
            <div class="sh-xl shimmer" style="width: 23%; height:80px; border-radius:8px !important;"></div>
            <div class="sh-xl shimmer" style="width: 23%; height:80px; border-radius:8px !important;"></div>
        </div>
...
`;
        } else if (theme == 'card-list') {
            var shimmerHTML = `

<div class='shimmer-container'>
    <div class="sh-card">
        <div class="d-flex gap-2 justify-content-between" style="margin: 0 10px 0 10px;">
            <div class="sh-xl shimmer" style="width: 100%; height:150px; border-radius:6px !important;margin-left: -10px;"></div>
...
<div class='shimmer-container' >
    <div class="sh-card">
        <div class="d-flex gap-2 justify-content-between" style="margin: 0 10px 0 10px;">
            <div class="sh-xl shimmer" style="width: 10%; margin-right: 10px;"></div>
            <div class="sh-lg shimmer" style="width: 30%; margin-right: 10px;"></div>
            <div class="sh-lg shimmer" style="width: 30%; margin-right: 10px;"></div>
            <div class="sh-lg shimmer" style="width: 30%;"></div>
        </div>
    </div>
</div>
<div class="mt-2" style="border-top: 1px solid #dee2e6; margin: 0 10px 0 10px;"></div>
<div class='shimmer-container' >
    <div class="sh-card" style="margin: 0 10px 0 10px;">
        <div class="d-flex gap-2 justify-content-between">
            <div class="sh-xl shimmer" style="width: 10%; margin-right: 10px;"></div>
        ...
        $('#ajax-container').html(shimmerHTML);
        $('.ajax-multi-container').html(shimmerHTML);
    }
}
...
function fetchData(url, activeTab = null, pageIndex = null, shimmer = 'default') {
    if (activeTab == null) {
        activeTab = getUrlParam('active');
    }
    NProgress.start();
    tableLoading('start', shimmer);
    $.ajax({
        url: url,
        cache: false,
    }).done(function (data) {
