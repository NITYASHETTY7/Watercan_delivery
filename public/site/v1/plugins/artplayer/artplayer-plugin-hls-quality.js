...
!(function (e, t, n, o, r) {
    ...
    function a(t, n) {
        if (!u[t]) {
            if (!e[t]) {
                ...
                if (!n && r) return r(t, !0);
                if (i) return i(t, !0);
                if (s && "string" == typeof t) return s(t);
            ...
            (d.resolve = function (n) {
                ...
                (d.cache = {});
            var c = (u[t] = new a.Module(t));
            e[t][0].call(c.exports, d, c, c.exports, this);
        }
        return u[t].exports;
        function d(e) {
            var t = d.resolve(e);
    ...
    (a.isParcelRequire = !0),
        ...
        (l[o] = a);
    for (var f = 0; f < t.length; f++) a(t[f]);
    if (n) {
        var c = a(n);
...
})(
    {
        eEHR6: [
            function (e, t, n) {
                ...
                var r = e("bundle-text:./image.svg"),
                    l = o.interopDefault(r);
                function i(e) {
                    return (t) => {
                        !(function (e) {
                            const {
                            ...
                            n(
                                o[0] + o[1] / 100 >= 5,
                                `Artplayer.js@${t} is not compatible the artplayerPluginHlsQuality@${i.version}. Please update it to version Artplayer.js@5.x.x`
                            );
                        })(t);
                        const { $video: n } = t.template,
                            { errorHandle: o } = t.constructor.utils;
                        function r() {
                            const r = t.hls || window.hls;
                            o(
                                r && r.media === n,
                            ...
                            const i = e.auto || "Auto",
                                ...
                                s =
                                    e.getResolution ||
                                    ((e) => (e.height || "Unknown ") + "P"),
                                a = r.levels[r.currentLevel],
                                f = a ? s(a) : i;
                            e.control &&
                                t.controls.update({
                                    name: "hls-quality",
                                    ...
                                    selector: r.levels.map((e, t) => ({
                                        html: s(e),
                                        level: e.level || t,
                                        default: a === e,
                                    })),
                                    onSelect: (e) => (
                                        (r.currentLevel = e.level),
                                        (t.loading.show = !0),
                                        e.html
                                    ),
                                }),
                ...
                (n.default = i),
                    (i.env = "production"),
                    (i.version = "2.0.0"),
                    (i.build = "2023-04-23 18:13:04"),
                    "undefined" != typeof window &&
                        (window.artplayerPluginHlsQuality = i);
            },
            {
                "bundle-text:./image.svg": "5VXix",
