...
class SettingRequest extends FormRequest
{
    ...
    {
        switch ($this->input('request_with')) {
            case 'create':
                $rules = [
                    'first_name' => 'required|min:'.validation('common_name', 1)['pattern']['minlength'].'|max:'.validation('common_name', 1)['pattern']['maxlength'].'|regex:'.regex('name', 1)['pattern'].'',
                        'min:' . validation('common_name', 1)['pattern']['minlength'],
                        'max:' . validation('common_name', 1)['pattern']['maxlength'],
                        'regex:' . regex('name', 1)['pattern'],
                    ],

                    'last_name' => 'required|min:'.validation('common_name', 1)['pattern']['minlength'].'|max:'.validation('common_name', 1)['pattern']['maxlength'].'|regex:'.regex('name', 1)['pattern'].'',
                        'min:' . validation('common_name', 1)['pattern']['minlength'],
                        'max:' . validation('common_name', 1)['pattern']['maxlength'],
                        'regex:' . regex('name', 1)['pattern'],
                    ],
                    ...
                    'phone' => [
                        'min:' . validation('tel_no', 1)['pattern']['minlength'],
                        'max:' . validation('tel_no', 1)['pattern']['maxlength'],
                        'regex:' . regex('common_phone_number', 1)['pattern'],
