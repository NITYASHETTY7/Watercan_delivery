...
trait CanManageFiles
{
    ...
    public function uploadFileInMedia($model ,$attachments, $collection_name): static
    {
        if(is_array($attachments)){
            foreach ($attachments as $attachment){
                $model->addMedia($attachment)->toMediaCollection($collection_name);
            }
        }else{
            $model->addMedia($attachments)->toMediaCollection($collection_name);
        }
        return $this;
    }
